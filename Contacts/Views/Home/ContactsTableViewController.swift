...
class ContactsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            contactViewModel.deleteContactAt(indexPath: indexPath)
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == ViewControllerSegue.ContactsDetailViewControllerSegue {
        ...
        else if segue.identifier == ViewControllerSegue.CreateContactViewSegue {
            let navigationViewController = segue.destination as? UINavigationController
            (navigationViewController?.topViewController as? CreateEditContactViewController)?.createEditContactViewModel = CreateEditContactViewModel()
        }
